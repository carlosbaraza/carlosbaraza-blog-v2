...
**Note:** After 90 days, the certificate will expire and the same process should be repeated to renew the certificate. [It is currently schedule the integration of letsencrypt within mupx](https://forums.meteor.com/t/setting-up-ssl-with-letsencrypt-and-meteorup/14457/15).
